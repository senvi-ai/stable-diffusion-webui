...
def create_ui():
                        ...
                        with FormRow():
                            ...
                            if opts.dimensions_and_batch_together:
                                with gr.Column(elem_id="txt2img_column_batch"):
                                    ...
                                    batch_size = gr.Slider(minimum=1, maximum=8, step=1, label='图片大小', value=1,
    ...
    interfaces = [
        (txt2img_interface, "AI绘图", "txt2img"),
        # (img2img_interface, "img2img", "img2img"),
        # (extras_interface, "Extras", "extras"),
        (pnginfo_interface, "导入模版", "pnginfo"),
    ...
    with gr.Blocks(theme=shared.gradio_theme, analytics_enabled=False, title="维森AI绘画工具") as demo:
